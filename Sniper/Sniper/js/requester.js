...
pm.helpers = {
    ...
    showRequestHelper: function (type) {
        ...
        else if (type.toLowerCase() === "mi") {
            pm.sniper.initMiConfigForm();
        }
        else if (type.toLowerCase() === "mapi") {
            pm.sniper.initMapiConfigForm();
        }
...
pm.request = {
    ...
    loadRequestInEditor:function (request, isFromCollection, isFromSample) {
        pm.request.showRequestBuilder();
        pm.helpers.showRequestHelper("mapi");
    ...
    prepareForSending: function() {
        ...
        else if (pm.helpers.activeHelper === "mi") {
            pm.sniper.processForMi();
        }
        else if (pm.helpers.activeHelper === "mapi") {
            pm.sniper.processForMapi();
        }
    ...
    getXhrHeaders: function() {
        ...
        if(pm.request.dataMode === "urlencoded" || pm.sniper.isSniperRawRequest()) {
